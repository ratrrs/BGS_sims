...
### Plot absolute values
```{r, fig.height=12}
legend <- get_legend(plot_over_time(maize,maize_events,'pi'))
plot_grid(ncol=2,rel_widths = c(90,10),
plot_grid(
plot_over_time(maize,maize_events,'pi')+theme(legend.position='none'),
plot_over_time(maize,maize_events,'xi')+theme(legend.position='none'),
plot_over_time(maize,maize_events,'tajD')+theme(legend.position='none'),
nrow = 3,align = 'hv',axis = 'lb'),
legend)
...
plot_ratios(maize,maize_events)
