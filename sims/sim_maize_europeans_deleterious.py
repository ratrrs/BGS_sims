...
output['run'] = run
output.to_csv("results/tmp_s5E-3/sim_neutralPi_maize_s5E-3_%d.csv"%run,index=False,header=False)


singleton = pd.DataFrame(rec1.singleton[1:],columns=rec1.singleton[0])
singleton['run'] = run
singleton.to_csv("results/tmp_s5E-3/sim_singleton_maize_s5E-3_%d.csv"%run,index=False,header=False)
...
output = pd.DataFrame(rec1.values[1:],columns=rec1.values[0])
output['run'] = run
output.to_csv("results/tmp_s5E-3/sim_neutralPi_European_s5E-3_%d.csv"%run,index=False,header=False)


singleton = pd.DataFrame(rec1.singleton[1:],columns=rec1.singleton[0])
singleton['run'] = run
singleton.to_csv("results/tmp_s5E-3/sim_singleton_European_s5E-3_%d.csv"%run,index=False,header=False)
