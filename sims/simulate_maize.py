...
sregion =   [fp11.GammaS(i, i + 1, 1., -0.29426, 0.184, h=1.0, coupled=True) for i in range(50)] +\
            [fp11.GammaS(i, i + 1, 2., -0.00518, 0.0415, h=1.0, coupled=True) for i in range(50)] # conserved non-coding DFE 2/3 of sel mutations in this region
